...
## 🛠️ Teknik Özellikler
- **Entegrasyon:** Yerel dosyaların Steam kütüphane formatına otomatik dönüştürülmesi.
- **Kullanıcı Arayüzü:** Hızlı ve kullanıcı dostu arayüz ile kolay yönetim.

## 💻 Kullanılan Teknolojiler
- **Dil:** [Python]
- **Kütüphaneler:** [`shutil` & `os`, `tkinter`, `pathlib`]
...
2. Steam dizininizi ve oyun dosyasını seçin.
3. "Entegre Et" butonuna basarak kütüphanenizi güncelleyin.

---
*Bu proje Muhammed İbrahim Sarıkaya tarafından geliştirilmiştir.*
